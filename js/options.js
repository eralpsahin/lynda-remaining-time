...
(function() {
  ...
  document.getElementById('radio1').addEventListener('input', save_options);
  document.getElementById('radio2').addEventListener('input', save_options);
  document
    .getElementById('total-checkbox')
